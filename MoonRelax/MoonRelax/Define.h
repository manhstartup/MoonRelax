...
#define COLOR_BACKGROUND_HOME_TOP 0x36223B
#define COLOR_BACKGROUND_HOME_BOTTOM 0x262262
#define COLOR_ICON_INACTIVE 0xFFFFFF
#define COLOR_ICON_ACTIVE 0xE91E64
#define COLOR_BUTTON_PLUS 0x4BDE78
...
#define COLOR_NAVIGATION_HOME 0x36223B
...
#define COLOR_SOUND_ITEM 0xfbb040
#define COLOR_TABBAR_BOTTOM 0x36223B
#define COLOR_TEXT_ITEM 0xFFFFFF
...
typedef enum
{
    SHORTCUT_ACTION_VOLUME = 1,
    SHORTCUT_ACTION_FAVORISTE,
    SHORTCUT_ACTION_TIMER,
    SHORTCUT_ACTION_INFO,
